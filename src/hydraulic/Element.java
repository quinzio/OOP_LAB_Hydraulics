...
public abstract class Element {
	...
	/**
	 * Connects this element to a given element. The given element will be
	 * connected downstream of this element
	 * 
	 * @param elem
	...
	public void connect(Element elem) {
		if (elem instanceof Sink)
			System.out.println("Error: Element is a sink.");
		this.connectedTo = elem;
	}
	...
	public abstract Object getFlowout();
